...
<head>
    ...
    <link rel="stylesheet" href="/used-wares/stylesheets/output.css">
...
<body class="bg-gray-50 font-jura">
    <header class="border-b-3">
        ...
        <!-- SEARCH BAR -->
        <form class="searchbar" action="/used-wares/pages/searchResult.php" method="GET">
        ...
        <!--<div class="flex flex-row justify-end">-->
            ...
            echo '<a class="hover:underline cursor-pointer text-blue-800" href="/used-wares/scripts/logout.php">&nbsp;Sign out</a>';
            }
            else{
            echo '<a class="hover:underline cursor-pointer text-blue-800" href="/used-wares/pages/loginPage.php">Sign in</a>';
            }
            ?>
        </div>
        </section>
        ...
        <nav class="text-center flex flex-row justify-center items-center gap-20 bg-gray-300">
            <a class="link" href="/used-wares/index.php">Home</a>
            <a class="link" href="/used-wares/pages/createPost.php">Create listing</a>
        <?php
        if($_SESSION["loggedIn"]){
            echo '<a class="link" href="/used-wares/pages/userPage.php">User page</a>';
        }   
        else{  
            echo '<a class="link" href="/used-wares/pages/createUser.php">Registrer</a>';
        }
        ?>
        </nav>
    </header>
