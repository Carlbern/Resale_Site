...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $env["ROOT"] ?>/stylesheets/output.css" />
...
<body class="bg-gray-50 font-jura">
    <header class="border-b-3">
        ...
        <!-- SEARCH BAR -->
	<form class="searchbar" action="<?php echo $env["ROOT"] ?>/pages/searchResult.php" method="GET">
        ...
        <!--<div class="flex flex-row justify-end">-->
            ...
            echo '<a class="hover:underline cursor-pointer text-blue-800" href="' . $env["ROOT"] . '/scripts/logout.php">&nbsp;Sign out</a>';
            }
            else{
            echo '<a class="hover:underline cursor-pointer text-blue-800" href="' . $env["ROOT"] . '/pages/loginPage.php">Sign in</a>';
            }
            ?>
        </div>
        </section>
	...
	<a class="link" href="<?php echo $env["ROOT"] ?>/index.php">Home</a>
	<a class="link" href="<?php echo $env["ROOT"] ?>/pages/createPost.php">Create listing</a>
        <?php
        if($_SESSION["loggedIn"]){
		echo '<a class="link" href="' . $env["ROOT"] . '/pages/userPage.php">User page</a>';
        }   
        else{  
            echo '<a class="link" href="' . $env["ROOT"] . '/pages/createUser.php">Registrer</a>';
        }
        ?>
        </nav>
    </header>
