...
include "db.php";
    ...
    while($row = mysqli_fetch_assoc($result)){
        ...
        echo '
        <article class="post">
                <img class="w-1/1 h-2/3" src="/used-wares/scripts/fetchImage.php?id=' . $id . '">
...
include "db.php";
    ...
    while($row = mysqli_fetch_assoc($result)){
        ...
        <article class="post relative ">                
                <img class=" w-1/1 h-2/3" src="/used-wares/scripts/fetchImage.php?id=' . $id . '" alt="No image for produkt">
                 <div class="m-2 text-sm text-gray-900 flex flex-col gap-1">
                    <p class="title truncate">' . $title . '</p>
                    <p class="price">' . $price . ':-</p>
                    ';
